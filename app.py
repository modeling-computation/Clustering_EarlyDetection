                ...
                <div style="margin-bottom: 18px;">
                    ...
                    <div class="summary-card-container">
                        <div class="summary-card" style="border-left: 8px solid #1f77b4;">
                            <div style="font-size: 14px; color: #666; font-weight: 600; margin-bottom: 5px;">Attention</div>
                        ...
                        <div class="summary-card" style="border-left: 8px solid #ff7f0e;">
                            <div style="font-size: 14px; color: #666; font-weight: 600; margin-bottom: 5px;">Caution</div>
                        ...
                        <div class="summary-card" style="border-left: 8px solid #d62728;">
                            <div style="font-size: 14px; color: #666; font-weight: 600; margin-bottom: 5px;">Severe</div>
            ...
            <div style="background-color: #f9f9f9; padding: 15px; border-left: 5px solid #2e86c1; margin-bottom: 20px;">
                ...
                <span style="font-size: 16px; color: #444; line-height: 1.6;">
                    <ul style="margin-top: 10px;">
                        ...
                        <li><strong style="color: #1F77B4;">Attention / Caution / Severe Dashed Lines</strong>: Mark the first dates when the cumulative bootstrap detection share becomes positive, reaches 5%, and reaches 10% within each season.</li>
